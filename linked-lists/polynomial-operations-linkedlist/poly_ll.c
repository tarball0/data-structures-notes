...
if (ptr1 == NULL) {
// If all terms from the first polynomial are added, take terms from the second polynomial
head3 = insert(head3, ptr2->coeff, ptr2->expo);
ptr2 = ptr2->link;
} else if (ptr2 == NULL) {
// If all terms from the second polynomial are added, take terms from the first polynomial
